 ...
 */ 
package com.espressoshock.drinkle.progressIndicator;
...
public class RingProgressIndicatorSkin implements Skin<RingProgressIndicator> {
    ...
    private void updateRadii() {
        ...
        fillerArc.setRadiusY(innerCircleRadius-5 + innerCircleHalfStrokeWidth - 1 + (ringWidth / 2));
        fillerArc.setRadiusX(innerCircleRadius-5 + innerCircleHalfStrokeWidth - 1 + (ringWidth / 2));
        fillerArc.setStrokeWidth(ringWidth+11);
        innerCircle.setRadius(innerCircleRadius-5);
    }
